        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <h5>RIO HAIR Co.</h5>
                    <p>Processors & Exporters of 100% Natural Human Hair. Serving the global beauty industry with premium quality products since 1997.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <p><i class="fas fa-map-marker-alt me-2"></i> Operations in India, Brazil, Dubai & Canada</p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="copyright">
                        &copy; 2023 RIO HAIR Co. All rights reserved. | Processors & Exporters (Trasformatori ed esportatori) | Established 1997
                    </div>
                </div>
            </div>
        </div>
